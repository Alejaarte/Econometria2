...
Pueden existir problemas de sobre-parametrización, lo cual se puede solucionar con la búsqueda de un modelo parsimonioso.

¿Cómo escogemos entre modelos? A través de criterios de información:
<ul>
...
<li> Criterio de Akaike (AIC). </li>
        ...
        AIC=-\log (MV)+2(k/T)
        \end{equation}
<li> Criterio de Scharwz (o criterio bayesiano) (BIC). </li>
        \begin{equation}
        BIC=-\log (MV)+\ln (T)*k/T
        \end{equation}
</ul>
