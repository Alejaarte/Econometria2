...
\begin{align}
\gamma_j & = \phi \gamma_{j-1} + E[\varepsilon_t  x_{t-j}]  + E[\varepsilon_t  x_{t-j}] - \theta E[\varepsilon_{t-1} x_{t-j}] \\
         & = \phi \gamma_{j-1}
\end{align}
...
Debido a lo anterior, pueden presentarse problemas de sobre-parametrización. Para solucionar esto, buscamos obtener un modelo parsimonioso, consiguiendo resultados similares con menor cantidad de parámetros.

#

¿Cómo escogemos entre modelos?
<ul>
<li> Criterio de Akaike (AIC)</li>
<li> Criterio de Schwarz (criterio bayesiano) (BIC)</li>
